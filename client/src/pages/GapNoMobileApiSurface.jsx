...
/**
 * Gap/CFS Feature Page: No mobile API surface.
 * Slug: no-mobile-api-surface
 * Backend: /api/gap-no-mobile-api-surface
 */
export default function NoMobileApiSurfacePage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-mobile-api-surface', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>No mobile API surface.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>No mobile API surface.</p>
