...
/**
 * Gap/CFS Feature Page: Debtor segmentation & targeting
 * Slug: debtor-segmentation-targeting
 * Backend: /api/cf-debtor-segmentation-targeting
 */
export default function DebtorSegmentationTargetingPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-debtor-segmentation-targeting', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Debtor segmentation & targeting</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Cluster debtors by characteristics; recommend targeted strategies by segment.</p>
