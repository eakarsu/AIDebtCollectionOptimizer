...
/**
 * Gap/CFS Feature Page: Limited credit-bureau integration.
 * Slug: limited-credit-bureau-integration
 * Backend: /api/gap-limited-credit-bureau-integration
 */
export default function LimitedCreditBureauIntegrationPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-limited-credit-bureau-integration', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Limited credit-bureau integration.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Limited credit-bureau integration.</p>
