...
/**
 * Gap/CFS Feature Page: No phone-system integration for automated outreach (SMS/email present but no dialer).
 * Slug: no-phone-system-integration-for-automated-outreach-sms-email
 * Backend: /api/gap-no-phone-system-integration-for-automated-outreach-sms-email
 */
export default function NoPhoneSystemIntegrationForAutomatedOutreachSmsEmailPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-phone-system-integration-for-automated-outreach-sms-email', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>No phone-system integration for automated outreach (SMS/email present but no dialer).</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>No phone-system integration for automated outreach (SMS/email present but no dialer).</p>
