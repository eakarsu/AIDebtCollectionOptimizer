...
/**
 * Gap/CFS Feature Page: Predictive contact strategy
 * Slug: predictive-contact-strategy
 * Backend: /api/cf-predictive-contact-strategy
 */
export default function PredictiveContactStrategyPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-predictive-contact-strategy', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Predictive contact strategy</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>ML model predicts optimal contact method/timing/message for each debtor; maximize contact success.</p>
