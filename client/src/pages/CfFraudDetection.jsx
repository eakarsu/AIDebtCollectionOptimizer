...
/**
 * Gap/CFS Feature Page: Fraud detection
 * Slug: fraud-detection
 * Backend: /api/cf-fraud-detection
 */
export default function FraudDetectionPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-fraud-detection', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Fraud detection</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Identify suspicious debtor/account patterns; flag for investigation.</p>
