...
/**
 * Gap/CFS Feature Page: Predictive compliance risk
 * Slug: predictive-compliance-risk
 * Backend: /api/cf-predictive-compliance-risk
 */
export default function PredictiveComplianceRiskPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-predictive-compliance-risk', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Predictive compliance risk</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Flag accounts at risk of FDCPA/TCPA violations before they occur.</p>
